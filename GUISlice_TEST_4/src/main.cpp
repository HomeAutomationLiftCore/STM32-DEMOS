...
//<Enum !Start!>
enum {E_PG_MAIN};
enum {E_ELEM_BTN1,E_ELEM_TEXT1};
// Must use separate enum for fonts with MAX_FONT at end to use gslc_FontSet.
enum {E_FONT_TXT10,E_FONT_TXT15,MAX_FONT};
//<Enum !End!>
...
//<InitGUI !Start!>
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT1,E_PG_MAIN,(gslc_tsRect){61,10,198,26},
    (char*)"BUTTON TEST",0,E_FONT_TXT15);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
  
  // create E_ELEM_BTN1 button with text label
  pElemRef = gslc_ElemCreateBtnTxt(&m_gui,E_ELEM_BTN1,E_PG_MAIN,
    (gslc_tsRect){100,80,120,40},(char*)"LED TOGGLE",0,E_FONT_TXT10,&CbBtnCommon);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
  gslc_ElemSetCol(&m_gui,pElemRef,GSLC_COL_BLACK,GSLC_COL_RED,GSLC_COL_GREEN);
