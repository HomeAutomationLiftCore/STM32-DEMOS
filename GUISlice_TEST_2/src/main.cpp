...
//<Enum !Start!>
enum {E_PG_MAIN};
enum {E_ELEM_TEXT1,E_ELEM_TEXT2};
...
//<InitGUI !Start!>
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT1,E_PG_MAIN,(gslc_tsRect){25,10,270,26},
    (char*)"TEXT INPUT TEST",0,E_FONT_TXT15);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
  
  // Create E_ELEM_TEXT2 text label
  static char mstr1[5] = "";
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT2,E_PG_MAIN,(gslc_tsRect){136,100,48,18},
    mstr1,sizeof(mstr1),E_FONT_TXT10);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
   m_pElemTEXT = pElemRef; // Save for quick access
//<InitGUI !End!>
...
void loop()
{
  ...
  char Txt[MAX_STR];
  snprintf(Txt,MAX_STR,"%u",COUNT);
  gslc_ElemSetTxtStr(&m_gui,m_pElemTEXT,Txt);
  // ------------------------------------------------
  // Update GUI Elements
  // ------------------------------------------------
