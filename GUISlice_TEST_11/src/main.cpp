...
//<InitGUI !Start!>
  ...
  pElemRef = gslc_ElemXRadialCreate(&m_gui,E_ELEM_RADIALGAUGE1,E_PG_MAIN,&m_sXRadialGauge1,
    (gslc_tsRect){80,40,140,140},0,10,0,GSLC_COL_BLUE_DK4);
  gslc_ElemSetCol(&m_gui,pElemRef,GSLC_COL_GRAY,GSLC_COL_BLACK,GSLC_COL_BLACK);
  gslc_ElemXRadialSetIndicator(&m_gui,pElemRef,GSLC_COL_BLUE_DK4,40,3,true);
  gslc_ElemXRadialSetTicks(&m_gui,pElemRef,GSLC_COL_RED,10,10);
  Rad1 = pElemRef;
//<InitGUI !End!>
...
void loop()
{
 if(Counter == 10){
  ...
  gslc_ElemXRadialSetVal(&m_gui,Rad1,Counter);
  delay(100);
  // ------------------------------------------------
  // Update GUI Elements
  // ------------------------------------------------
